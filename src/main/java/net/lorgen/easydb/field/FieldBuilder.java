...
public class FieldBuilder<T> {
     ...
     * @return This
     */
    public FieldBuilder<T> setAsKey() {
        this.key = true;
        return this;
    }
     ...
     * @return This
     */
    public FieldBuilder<T> setAutoIncrement() {
        this.autoIncr = true;
        return this;
    }
     ...
     * @return This
     */
    public FieldBuilder<T> setIndex() {
        this.index = true;
    ...
    /**
     * Sets this field as a unique index. Also invokes {@link #setIndex()}.
     *
     * @return This
     */
