...
public @interface External {
     ...
     * If this is used, {@link #saveKeyLocally()} should be set to false. If
     * {@link #saveKeyLocally()} isn't used, and this is left empty, an attempt
     * will be made to match keys in this type to that of the stored type in this
     * field.
     */
     ...
     * if we shouldn't save them when we save this item
     */
