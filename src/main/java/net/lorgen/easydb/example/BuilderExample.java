    ...
    static {
        ...
        new QueryBuilder<>(null) // This is NOT how you make a new builder, but for this example we use it
          ...
          .where() // Start building a requirement
              .andOpen()  // We move down a level, so we can make a sub requirement of some form
                // It doesnt matter if you do "and" or "or" for the first argument
                .andEquals("id", 15) // We are looking for entries where the "id" is 15
              ...
              .andOpen() // We now move back up. This is a different requirement. So far the ID can be either 15 or 16.
                .andEquals("number", 12) // Now "number" has to be 12
