...
public class Repositories {
    ...
    public static <G, T extends ItemRepository<G>> T createRepository(DatabaseType type, String table, Class<G> typeClass, Class<T> repoClass, ItemProfile<T> profile) {
        return createRepository(null, type, table, typeClass, repoClass, profile);
    }

    public static <G, T extends ItemRepository<G>> T createRepository(DatabaseType type, String table, Class<G> typeClass) {
        return createRepository(type, table, typeClass, null);
    }

    public static <G, T extends ItemRepository<G>> T createRepository(DatabaseType type, String table, Class<G> typeClass, Class<T> repoClass) {
        return createRepository(null, type, table, typeClass, repoClass);
    }

    public static <G, T extends ItemRepository<G>> T createRepository(ConnectionConfiguration config, DatabaseType type, String table, Class<G> typeClass, Class<T> repoClass) {
        return createRepository(config, type, table, typeClass, repoClass, null);
    }
